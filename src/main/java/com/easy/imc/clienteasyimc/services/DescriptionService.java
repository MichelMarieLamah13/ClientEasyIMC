...
public class DescriptionService {
    ...
    public static IMCResponse<DescriptionModel> findByIdCategory(int id){
        ...
        try {
            URL url = new URL(API.getUrlFindByIdCategoryFromDescriptions(id));
    ...
    public static IMCResponse<DescriptionModel> getList(HttpURLConnection connection) throws IOException {
        IMCResponse<DescriptionModel> result = new IMCResponse<>();
        ...
        if(responseCode == HttpURLConnection.HTTP_OK){
            try (BufferedReader in = new BufferedReader(new InputStreamReader(connection.getInputStream()))) {
                ...
                TypeReference<IMCResponse<DescriptionModel>> typeReference = new TypeReference<>() {};
