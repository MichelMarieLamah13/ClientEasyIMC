...
public class UniteTailleService {
    ...
    public static IMCResponse<UniteTailleModel> getAll(){
        IMCResponse<UniteTailleModel> result = new IMCResponse<>();
        try {
            URL url = new URL(API.getUrlForGetAllUniteTaille());
    ...
    public static IMCResponse<UniteTailleModel> getList(HttpURLConnection connection) throws IOException {
        IMCResponse<UniteTailleModel> result = new IMCResponse<>();
        ...
        if(responseCode == HttpURLConnection.HTTP_OK){
            try (BufferedReader in = new BufferedReader(new InputStreamReader(connection.getInputStream()))) {
                ...
                TypeReference<IMCResponse<UniteTailleModel>> typeReference = new TypeReference<>() {};
